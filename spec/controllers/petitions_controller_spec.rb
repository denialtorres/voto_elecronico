...
RSpec.describe PetitionsController, type: :controller do
  ...
  describe 'GET #new' do
    it 'assigns a new petition as @petition' do
      get :new, params: {},
          session: valid_session
      expect(assigns(:petition)).to be_a_new(Petition)
    end
  end
  ...
  describe 'GET #edit' do
    it 'assigns the requested petition as @petition' do
      petition = Petition.create! valid_attributes
      get :edit, params: { id: petition.to_param },
          session: valid_session
      expect(assigns(:petition)).to eq(petition)
    end
  end
  ...
  describe 'POST #create' do
    context 'with valid params' do
      it 'creates a new Petition' do
        expect do
          post :create, params: { petition: valid_attributes },
               session: valid_session
      ...
      it 'assigns a newly created petition as @petition' do
        post :create, params: { petition: valid_attributes },
             session: valid_session
        expect(assigns(:petition)).to be_a(Petition)
        expect(assigns(:petition)).to be_persisted
      end
    ...
    context 'with invalid params' do
      it 'assigns a newly created but unsaved petition as @petition' do
        post :create, params: { petition: invalid_attributes },
             session: valid_session
        expect(assigns(:petition)).to be_a_new(Petition)
      end
  ...
  describe 'PUT #update' do
    context 'with valid params' do
      ...
      it 'updates the requested petition' do
        petition = Petition.create! valid_attributes
        put :update, params: { id: petition.to_param, petition: new_attributes },
            session: valid_session
        petition.reload
      ...
      it 'assigns the requested petition as @petition' do
        petition = Petition.create! valid_attributes
        put :update, params: { id: petition.to_param, petition: valid_attributes },
            session: valid_session
        expect(assigns(:petition)).to eq(petition)
      end
    ...
    context 'with invalid params' do
      it 'assigns the petition as @petition' do
        petition = Petition.create! valid_attributes
        put :update, params: { id: petition.to_param, petition: invalid_attributes },
            session: valid_session
        expect(assigns(:petition)).to eq(petition)
      end
  ...
  describe 'DELETE #destroy' do
    it 'destroys the requested petition' do
      petition = Petition.create! valid_attributes
      expect do
        delete :destroy, params: { id: petition.to_param },
               session: valid_session
      end.to change(Petition, :count).by(-1)
    end
